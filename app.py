...
tab_meta, tab_journey, tab_profile, tab_forms, tab_free = st.tabs(
    [
        "Meta vista general",
        "Lead Journey",
        "Perfilamiento-SQL",
...
- **Conversión acumulada:** etapa actual ÷ Registros.
    ...
    def build_sales_pie_data(data, ad_name, reason_col="Stage"):
        ad_data = data[
